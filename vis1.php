...
$dbname = "id4216850_details";
   ...
   // $pass = mysqli_real_escape_string($conn,$_POST['password']); 	
    $res ="SELECT * FROM (SELECT * FROM chro_data order by entryid asc limit 4) sub order by entryid asc; ";
...
<br>
  <div class="dropdown">
      <br>
<br>
    <button class="btn btn-mg btn-primary dropdown-toggle" type="button" data-toggle="dropdown">Distance
